...
class ResourceMonitor:
    def __init__(self, host, username=None, password=None, snmp_port=161, snmp_community='public'):
        self.host = host
    ...
    def get_snmp_data(self) -> dict:
        ...
        try:
            ...
            errorIndication, errorStatus, errorIndex, varBinds = next(
                getCmd(SnmpEngine(),
                      CommunityData(self.snmp_community, mpModel=1),  # SNMPv2c 명시적 지정
            ...
            if errorIndication:
                ...
                return {metric.lower(): -1 for metric in snmp_oids.keys()}
            elif errorStatus:
